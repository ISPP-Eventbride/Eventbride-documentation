...
| RI-5 | Invitación | Alta | La invitación constará de nombre, apellidos, número de teléfono, mínimo y máximo de invitados asociados a la invitación, email, el evento al que corresponde y el estado de la misma (Enviada, Recibida o Aceptada).|
