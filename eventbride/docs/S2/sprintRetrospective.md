...
Este documento tiene como objetivo presentar una retrospectiva del Sprint 2 del proyecto *Eventbride*. Se abordarán las buenas prácticas llevadas a cabo durante el sprint, los aspectos que se deben mejorar y las áreas en las que se puede optimizar el proceso de trabajo en el futuro. Además, se establecerán los objetivos para el siguiente sprint, teniendo en cuenta las lecciones aprendidas.

<div id='id1'></div>

## Análisis de las acciones realizadas durante este sprint

| Nombre                                 | Acciones realizadas |
|----------------------------------------|---------------------|
| Adrián Cabello Martín                  | Reserva de contratación de servicios, Vídeo demo 1/2 Sprint, Vídeo Demo semana 7, Implementar plataforma de pago, Gestionar más de 1 evento con el mismo servicio, Poner la UI acorde, Plan premium y plan freemium   |
| Andrés Pizzano Cerrillos               | Reserva de contratación de servicios, Workflows, Poner la UI acorde, Controlar accesos rutas  |
| Antonio Montero López                  | Pensar story board, Dibujar story board, Elaborar presentación, Documento cómo se hacen las revisiones de las tareas, Validez de formularios |
| Daniel Benito Hidalgo                  | Pensar story board, Dibujar story board, Análisis Sonarqube, Elaborar presentación, Contenido a redes sociales, Gestión de usuarios pilotos, Pensar intro para la presentación  |
| David Godoy Fernández                  | Elaborar presentación, Gestión de usuarios pilotos, Creación y gestión de listas de invitados, Gestionar más de 1 evento con el mismo servicio  |
| Fernando José de Celis Hurtado         | Vídeo demo 1/2 Sprint, Vídeo Demo semana 7, Implicaciones legales, Creación y gestión de listas de invitados, Customer agreement, Actualizar términos y condiciones |
| Francisco Avilés Carrera               | Reserva de contratación de servicios, Análisis Sonarqube, Revisar Deliverable Failure Conditions, Revisar documento costsAnalysis.md, Editar perfil  |
| Gonzalo Navas Remmers                  | Gestión de usuarios pilotos, Modificar relación Rating-Service y Usuario-Service, Arreglar forms en frontend, Reserva de contratación de servicios, Poner la UI acorde, Implementar plataforma de pago final, Eliminar servicio, Subir comisiones, Creación y gestión de listas de invitados  |
| Héctor Noguera González                |  Solicitud de reserva de contratación de servicios y página de detalles del servicio backend, Actualizar problems.md, Código de conducta, Plan premium y plan freemium, Actualizar documento de problemas encontrados, chat, Pensar recompensas para los mejores trabajadores |
| Ignacio Blanquero Blanco               | Pasar feedback del viernes a md, Documento uso de la IA, Actualizar KBReport.md, Time effort Report, Añadir mapa, Changelog  |
| Lorenzo Torralba Lanzas                | Creación y gestión de listas de invitados, Workflows, Cancelación del servicio, Añadir sección preguntas frecuentes al footer de la web, Eliminar servicio  |
| Manuel Pérez Vélez                     |  Solicitud de reserva de contratación de servicios y página de detalles del servicio backend, Crear invitaciones para intro presentación, Eliminar etiquetados de la cuenta de Instagram, Calendario compartido, Documento cómo se hacen las revisiones de las tareas |
| María de la Salud Carrera Talaverón    | Crear rama Develop, Actualizar Commitment Agreement, Revisar Deliverable Failure Conditions, Documento cómo se hacen las revisiones de las tareas, Actualizar "Análisis cualitativo y cuantitativo", Modificar documento de métricas, Hacer release mitad de Sprint, Mover todos los documentos a un repositorio aparte |
| Miguel Hernández Sánchez               | Creación y gestión de listas de invitados, Modificar relación Rating-Service y Usuario-Service, Plan premium y plan freemium, chat, Cancelación del servicio, Poner la UI acorde  |
| Natalia Olmo Villegas                  | Pensar story board, Sprint planning, Solicitud de reserva de contratación de servicios y página de detalles del servicio backend, Pensar intro para la presentación, Revisar Deliverable Failure Conditions, Corregir Customer Agreement |
| Pablo Jesús Castellanos Compaña        | Pensar story board, Solicitud de reserva de contratación de servicios y página de detalles del servicio backend, Modificar relación Rating-Service y Usuario-Service, Arreglar forms en frontend, Coste total evento, Actualizar datos de la base de datos, Elaborar presentación, Evaluación rendimiento, Plan premium y plan freemium, Poner la UI acorde, Controlar accesos rutas, Revisar Deliverable Failure Conditions, Editar perfil, Mover todos los documentos a un repositorio aparte, Actualizar datos de la base de datos  |
| Sergio Pons López                      | Coste total evento, Evaluación rendimiento, Retrospectiva 1/2 Sprint 2, Modificar README, Validez de formularios, Mover todos los documentos a un repositorio aparte, Pasar feedback de esta semana a md, Retrospectiva Sprint 2 |
