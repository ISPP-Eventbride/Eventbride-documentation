...
También revisé el estudio sobre el grado de innovación tecnológica desarrollado por mis compañeros.
...
Durante las tres semanas correspondientes al Sprint 1, que abarcan el período comprendido entre el 21 de febrero y el 14 de marzo, he llevado a cabo diversas tareas en el marco del proyecto.
...
Por otro lado, ayudé a elaborar la presentación de la semana 5 y que se cumplieran todos los puntos del feedback de los profesores, además de pensar la idea de killer opening: el vídeo relacionado con "La isla de las tentaciones" e "Illojuan"y editar el vídeo.
...
Después realicé la configuración del entorno del proyecto y la instalación del mismo en mi equipo para poder trabajar en él.
...
En primer lugar, elaboré el documento "Performance Evaluation", en el que se evalúa el rendimiento individual y grupal del equipo, identificando fortalezas, áreas de mejora y aportaciones clave de cada miembro durante las distintas fases del desarrollo. Este análisis resulta crucial para fomentar la mejora continua y reconocer el trabajo realizado.
...
Asimismo, me encargué de crear y editar un vídeo de marketing con el objetivo de presentar a los integrantes del equipo de una manera atractiva y profesional, útil tanto para difusión interna como externa del proyecto.
...
Comencé corrigiendo el anuncio dirigido a inversores, aplicando el feedback que recibimos tras el sprint 3. Posteriormente, grabé dos capítulos de una miniserie que tenemos previsto publicar en nuestras redes sociales bajo el nombre "DivinasTV".
...
Al pasar la mitad del sprint, he realizado la edición del primer vídeo de divinasTV, que es la tarea a la que más tiempo he ocupado. Además, asistí a la reunión retrospectiva de la semana; realice las presentaciones finales del sprint junto con mi compañero Daniel Benito; y realicé revisiones de PRs.
...
Cabe destacar que desempeño el rol de secretario dentro del equipo, por lo que asistí a las tres reuniones celebradas durante el PPL y redacté las actas correspondientes a cada una. Asimismo, asistí a todas las clases que se impartieron durante el desarrollo del PPL.
...
A lo largo del Sprint, he revisado múltiples *pull requests*, ejerciendo activamente mi papel de revisor y proponiendo mejoras tanto en el código como en la documentación asociada. Además, he asistido a la mayoría de las reuniones programadas, contribuyendo de forma constante al seguimiento y a la coordinación general del equipo.
...
También recogí el feedback proporcionado por la clase durante la sesión del 2 de mayo, con el objetivo de incorporar sugerencias y observaciones valiosas que contribuyeran a la mejora continua del proyecto y su presentación final.
...
Asimismo, he participado activamente en la producción de contenido audiovisual, grabando múltiples vídeos y realizando un proceso de edición en el que he seleccionado y conservado únicamente las partes más relevantes y útiles para su posterior integración en los materiales de marketing o presentación.

Por último, he prestado mi colaboración en tareas de edición de la serie "Divinas", contribuyendo a su mejora tanto técnica como narrativa, en línea con los estándares de calidad y estilo definidos por el equipo.

### Carrera Talaverón, María de la Salud

Desde el inicio del WPL, he desempeñado un papel activo en tareas de coordinación, participando en la planificación de los sprints (Sprint Planning), en la reestimación de tareas, en la toma de decisiones importantes a nivel grupal y en el seguimiento del progreso de las tareas asignadas al subgrupo que coordino. Esta labor ha sido fundamental para asegurar una correcta organización del equipo y un desarrollo ordenado del proyecto.

Durante la primera semana, me encargué de reescribir los "Commitment Agreements", elaborando una nueva versión que recogiera los roles actualizados del equipo. Asimismo, redacté el análisis cuantitativo y cualitativo correspondiente a la primera mitad del entregable, y preparé la estructura de carpetas del repositorio destinada a la documentación del WPL. También me ocupé de reemplazar una dirección de correo electrónico que había dejado de funcionar, realizando la sustitución en todos los archivos relevantes de ambos repositorios.

Adicionalmente, actualicé el logotipo de Eventbride en los documentos del WPL y en la propia aplicación, asegurando la coherencia visual del proyecto. Elaboré un breve guion para la grabación de un vídeo de presentación del equipo y participé en su grabación, realizada tras el seguimiento individual de la asignatura. Finalmente, me encargué de realizar la release intermedia del entregable en el repositorio de código.

En la segunda semana, volví a actualizar el análisis cuantitativo y cualitativo, adaptándolo a la situación final del equipo. Detecté que algunos documentos se habían actualizado por error en la carpeta del PPL, por lo que restauré las versiones correspondientes y los ubiqué correctamente en la carpeta del WPL. También revisé todos los documentos incluidos en esta entrega para asegurarme de que se visualizaban adecuadamente tanto en GitHub como en la aplicación.

Además, realicé dos publicaciones (releases), una en el repositorio de código y otra en el repositorio de documentación, garantizando que ambas estuvieran organizadas y accesibles. Por último, llevé a cabo el despliegue de la aplicación Docusaurus, dejando la documentación alojada y funcional, lista para su consulta.

### Castellanos Compaña, Pablo Jesús

Durante el Sprint comprendido entre el 2 y el 22 de mayo, he llevado a cabo diversas tareas relacionadas con el desarrollo del WPL, adaptando mi grado de implicación según las necesidades del equipo y las circunstancias del periodo.

En la primera semana del Sprint, llevé a cabo, junto con Natalia Olmo, la asignación de tareas correspondientes al WPL. Dado que esta semana coincidió con la Feria de Sevilla, no se avanzó significativamente en otras tareas operativas, quedando limitada la actividad a dicha organización inicial.

Durante la segunda semana, del 9 al 15 de mayo, participé activamente en las grabaciones de diversos vídeos destinados a la promoción y comunicación del proyecto, como parte del equipo de marketing.

En la tercera semana, comprendida entre el 16 y el 22 de mayo, colaboré en la edición de los vídeos grabados la semana anterior. Asimismo, actualicé conjuntamente con Francisco Avilés el documento de costes del proyecto y revisé con él las condiciones establecidas en el documento *Deliverable Failure Conditions*, asegurando que se cumplían adecuadamente.

Cabe destacar que, debido al elevado número de horas ya acumuladas en fases anteriores y a petición expresa del equipo, durante estas semanas he reducido mi participación directa en la ejecución activa de tareas. No obstante, he estado presente como apoyo continuo, aportando ideas y comentarios constructivos en las tareas de marketing que se han ido desarrollando, motivo por el cual no he considerado necesario registrar un conteo detallado de mis contribuciones.

Finalmente, resalto que he asistido a todas las reuniones establecidas, incluyendo tanto las reuniones generales celebradas los miércoles y sábados, como las reuniones específicas de jefes de equipo realizadas los sábados.

### De Celis Hurtado, Fernando José

Durante el desarrollo del WPL, he participado en diversas tareas relacionadas principalmente con la producción y edición de contenido audiovisual, contribuyendo de manera activa al apartado de difusión y presentación del proyecto.

Mi trabajo comenzó con la edición del primer tutorial de Eventbride, centrado en la creación de eventos dentro de la plataforma. Posteriormente, participé en la grabación del tercer y último capítulo de la serie "Tu boda a juicio", colaborando con los compañeros asignados a dicho contenido.

Tras ello, me encargué de la edición del segundo y tercer tutorial de Eventbride, dedicados respectivamente al uso del sistema de chat y a las funcionalidades disponibles para los proveedores. Finalmente, completé la edición del vídeo demo que será proyectado durante la presentación oficial del WPL, asegurando que refleje de forma clara y atractiva el funcionamiento y valor añadido de la plataforma.
...
Durante este Sprint, he centrado mi trabajo principalmente en las tareas del área de marketing, prestando especial atención a la edición de contenido audiovisual.

En la primera semana, completé la edición del programa de DivinasTV, utilizando un nuevo software de edición. Esta decisión implicó una mayor carga de trabajo inicial, pero permitió obtener una calidad superior en los vídeos, con una estética más profesional en comparación con los anteriores. Dado que se trata de un contenido destinado a nuestro canal oficial de YouTube, era fundamental asegurar un resultado visualmente atractivo. Asimismo, colaboré con mi compañero Pablo Jesús Castellanos en la actualización del logotipo corporativo de la empresa.

Durante la segunda semana, presté apoyo en la edición del segundo y tercer capítulo de DivinasTV, además de participar en diversas grabaciones para futuras publicaciones. Finalmente, asistí a la reunión de retrospectiva correspondiente a dicha semana, contribuyendo a la evaluación del trabajo realizado y a la planificación de las siguientes tareas.

### Navas Remmers, Gonzalo

Durante el desarrollo del World Project Launch, he participado activamente en diversas tareas orientadas a la creación y edición de contenido audiovisual y promocional.

Inicialmente, me encargué de la edición del vídeo de presentación del equipo, asegurando que reflejara de forma clara y dinámica la identidad del grupo. Posteriormente, colaboré con mi compañero Lorenzo en la creación de un flyer publicitario, diseñado con el objetivo de captar la atención de potenciales usuarios y colaboradores.

En relación con el vídeo demostrativo de la aplicación, fui responsable de la elaboración del guion y de la grabación de los distintos clips necesarios para su posterior edición, garantizando una narrativa coherente y visualmente atractiva. Finalmente, llevé a cabo la edición del vídeo destinado a los proveedores, utilizando el material previamente grabado para mostrar de forma efectiva las funcionalidades específicas orientadas a este perfil de usuario.

### Noguera González, Héctor

Durante el transcurso del World Project Launch, he centrado mi trabajo en tareas clave relacionadas con la presentación y el desarrollo técnico del proyecto.

En una primera fase, me ocupé de la preparación de la presentación de la retrospectiva ante los profesores, asegurando que se reflejara de forma clara y estructurada el trabajo realizado, los retos enfrentados y los aprendizajes obtenidos por el equipo a lo largo del desarrollo del proyecto.

Durante la segunda semana, colaboré con Miguel en la creación de la APK de la aplicación, contribuyendo al proceso de compilación y empaquetado necesario para su distribución y prueba en dispositivos móviles. Paralelamente, también trabajé en la actualización del documento de problemas, incorporando los incidentes detectados más recientes y las soluciones implementadas, con el objetivo de mantener un registro actualizado y útil para la mejora continua del producto.

### Olmo Villegas, Natalia

Durante este último entregable del World Project Launch, he desempeñado un papel fundamental como Project Manager del grupo y coordinadora del área de marketing, asumiendo responsabilidades clave tanto en la planificación como en la ejecución de tareas estratégicas.

En primer lugar, me encargué de planificar todas las tareas correspondientes al Sprint, lo que implicó una considerable inversión de tiempo y esfuerzo para asegurar una correcta distribución de responsabilidades y una secuencia lógica de trabajo. Esta planificación fue esencial para mantener el ritmo del equipo y garantizar que se cumplieran los objetivos propuestos dentro del plazo establecido.

Adicionalmente, elaboré un calendario detallado con la planificación del contenido a publicar en redes sociales, en el que se especificaban las fechas de publicación y los responsables de cada contenido. A lo largo del Sprint, realicé un seguimiento constante, recordando al equipo qué publicaciones debían subirse cada día y verificando que se cumplieran los tiempos marcados.

Por último, también asumí la edición de los dos capítulos publicados de la serie “Tu boda a juicio”, asegurando una calidad audiovisual acorde con los estándares definidos para los materiales de difusión del proyecto.

### Pérez Vélez, Manuel

Durante este Sprint, he centrado mis esfuerzos en diversas tareas relacionadas con la promoción y la comunicación de la aplicación Eventbride.

En primer lugar, me encargué de la creación del cartel publicitario de la aplicación, diseñado específicamente para ser mostrado en las pantallas de la universidad. El objetivo de este material fue aumentar la visibilidad del proyecto entre la comunidad universitaria y generar interés en su uso.

Asimismo, elaboré el guion para el vídeo dirigido a proveedores, teniendo en cuenta las observaciones y sugerencias recibidas en la última sesión de seguimiento. Este trabajo permitió adaptar el contenido del vídeo para que resultara más claro, directo y alineado con las expectativas del público objetivo.

Finalmente, gestioné la publicación de varias encuestas y otros contenidos en la cuenta oficial de Instagram del proyecto, con la finalidad de obtener feedback de nuestros seguidores sobre distintos aspectos de la aplicación y, al mismo tiempo, dar a conocer sus funcionalidades de forma dinámica y accesible.
...
Durante el desarrollo del World Project Launch, he llevado a cabo diversas tareas clave en las áreas de gestión, documentación, marketing y soporte al usuario, contribuyendo activamente al correcto avance del proyecto.

En primer lugar, elaboré junto a mi compañero Ignacio Blanquero el documento de Sprint Planning, siguiendo la planificación y el reparto de tareas establecidos por el grupo de jefes, reflejados en el tablero de trabajo de GitHub. Además, he asistido regularmente a las reuniones del equipo, desempeñando el rol de secretario, lo que ha implicado la redacción tanto del documento de retrospectiva de mitad de Sprint como del de retrospectiva final, así como la elaboración de las actas de cada sesión.

También trabajé junto a Lorenzo Torralba en un análisis del impacto de las redes sociales y las acciones de marketing realizadas durante el Sprint, lo cual sirvió de base para evaluar el alcance y la efectividad de nuestras estrategias. Como parte de esta línea de trabajo, desarrollé la estrategia de lead magnets, estructurada en tres apartados, destinada a mostrar a los usuarios el valor añadido de registrarse en Eventbride y de utilizar nuestra plataforma para organizar sus eventos.

En el ámbito de la documentación, colaboré con Héctor Noguera en la actualización del Manual de Usuario, incorporando los cambios recientes en la interfaz de la aplicación. Mientras él me proporcionaba las capturas correspondientes, me encargué de integrarlas adecuadamente en el documento, asegurando que la guía fuera clara y estuviera completamente actualizada.

Por último, he asistido a ambas clases programadas durante este Sprint: la defensa intermedia y la sesión sobre presentaciones, manteniéndome implicado en todas las actividades académicas relacionadas con el proyecto.

### Torralba Lanzas, Lorenzo

Durante el transcurso del World Project Launch (WPL), he desarrollado una serie de tareas centradas en la mejora de la aplicación, la gestión del contenido audiovisual, y la colaboración en acciones de marketing y documentación técnica.

En primer lugar, trabajé en la paginación de la pestaña de notificaciones, con el objetivo de mejorar la experiencia de usuario y hacerla más cómoda e intuitiva. A continuación, me encargué de subir los vídeos demostrativos de la aplicación a YouTube, para que estuvieran disponibles y fácilmente accesibles en el momento de compartirlos durante presentaciones o acciones promocionales.

Posteriormente, realicé una modificación en la lógica de navegación de la aplicación, configurando la página principal como "Home" en lugar de "Login". Además, habilité el acceso público a las secciones de servicios y recintos disponibles, permitiendo a los usuarios no autenticados consultar información general, pero ocultando botones interactivos y valoraciones para restringir funcionalidades completas a quienes hayan iniciado sesión o se hayan registrado. También ajusté el diseño del logo en el navbar, optimizando su tamaño para que no interfiriera con el resto del contenido.

En colaboración con mi compañero Sergio, elaboramos el documento de análisis de marketing, evaluando el impacto generado por los vídeos promocionales publicados en redes sociales. Además, implementé un sistema para que la sesión del usuario se cierre automáticamente cuando el token haya expirado, evitando así que la aplicación permanezca activa tras largos periodos de inactividad.

En el área de diseño, trabajé junto a mi compañero Gonzalo en la creación de flyers publicitarios, destinados a promocionar la aplicación de forma visual y atractiva. También participé en la grabación del vídeo promocional dirigido a proveedores, aportando tanto a nivel técnico como creativo. Por último, me encargué de actualizar el changelog de la aplicación, documentando todos los cambios relevantes implementados durante el Sprint.
