...
| 21/05/2025 | v1.10    | Redacción del problema 15 | WPL | Héctor Noguera González |
...
16. [Problema 15: Cambio de dirección de correo al finalizar el PPL](#id15)
17. [Rendimiento y Evaluación de Acciones](#Rendimiento)
...
## Problema 15: Cambio de dirección de correo al finalizar el PPL

### Trazabilidad del problema

Al concluir el PPL, se identificó que la dirección de correo de soporte utilizada en la aplicación estaba asociada a un dominio que requería un pago para su renovación.

Dado que se decidió no asumir el costo del dominio, fue necesario cambiar la dirección de correo a una cuenta gratuita, lo que generó cierta confusión y pérdida de continuidad en las comunicaciones posteriores.


### Acciones concretas tomadas

- Se creó una nueva dirección de correo gratuita y se comunicó a los participantes y destinatarios relevantes.
- Se actualizó la información de contacto en los documentos más importantes y en la aplicación.


### Cómo saber si está funcionando

- No deben registrarse nuevos incidentes relacionados con direcciones de correo incorrectas o perdidas.
- La nueva cuenta debe mantenerse activa y funcional para comunicaciones posteriores.

### Objetivo

Evitar interrupciones en la comunicación , asegurando la disponibilidad y continuidad de los canales de contacto.

### Cuándo se espera alcanzar el objetivo

Inmediatamente tras cambiar la dirección y en el futuro.

### ¿Están funcionando las cosas?

Sí, la nueva dirección de correo está funcionando adecuadamente, aunque se reconocen oportunidades para mejorar la planificación anticipada en el futuro.
...
<center><img src="https://iili.io/3QCij5v.md.png"></img></center>
<center><img src="https://iili.io/3QCmTS1.md.png"></img></center>

<center><img src="https://iili.io/3QnHqdB.md.png"></img></center>
